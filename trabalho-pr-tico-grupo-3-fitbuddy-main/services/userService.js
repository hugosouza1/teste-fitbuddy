...
import { parsePotentialDate } from './dataService';

const DEFAULT_PROFILE_PIC = 'https://cdn-icons-png.flaticon.com/512/149/149071.png';


export async function carregarUsuario(email, BACKEND_URL) {
  ...
  try {
    ...
    // normalizações (conforme discutido antes)
    ...
    // Retornar o objeto útil para a UI evitar ler do AsyncStorage logo em seguida
    return {
      email: emailToStore,
      nome: nomeToStore,
